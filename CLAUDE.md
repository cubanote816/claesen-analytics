...
| CLA-498 | FieldOps: fix BOLA en upload de media (`FieldOpsMediaController::store()`, tercer ticket de la batería de 16) | ✅ Implementado, testeado (gate serial 200/654 en verde) y verificado con QA real en dev; pendiente de commit/push/deploy y cierre en Linear. Ver detalle abajo |
