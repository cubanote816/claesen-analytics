...
### FieldOps: breadcrumbs jerárquicos en páginas Create, en TODAS las páginas de Electrical Board, ocultarlo del sidebar y fix de título vacío (2026-08-01, sin ticket formal, commits `e868110` + `2dc5936` + `efcb586` + `b36807f`)
