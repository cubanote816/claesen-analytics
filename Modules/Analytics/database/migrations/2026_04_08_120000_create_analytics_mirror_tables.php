...
return new class extends Migration
{
    ...
    {
        // 1. Projects Mirror
        Schema::create('analytics_mirror_projects', function (Blueprint $blueprint) {
        ...
        Schema::create('analytics_mirror_employees', function (Blueprint $blueprint) {
        ...
        Schema::create('analytics_mirror_labor_types', function (Blueprint $blueprint) {
            $blueprint->integer('id')->primary();
        ...
        // 4. Labor Logs Mirror
        Schema::create('analytics_mirror_labor', function (Blueprint $blueprint) {
        ...
        // 5. Materials Mirror
        Schema::create('analytics_mirror_materials', function (Blueprint $blueprint) {
            $blueprint->integer('id')->primary();
        ...
        // 6. Costs Mirror (MAMO)
        Schema::create('analytics_mirror_costs', function (Blueprint $blueprint) {
            $blueprint->string('id', 50)->primary(); // Match legacy ID type
            $blueprint->string('project_id', 15)->index();
    ...
    {
        Schema::dropIfExists('analytics_mirror_costs');
        Schema::dropIfExists('analytics_mirror_materials');
        Schema::dropIfExists('analytics_mirror_labor');
        Schema::dropIfExists('analytics_mirror_labor_types');
        Schema::dropIfExists('analytics_mirror_employees');
        Schema::dropIfExists('analytics_mirror_projects');
    }
};
