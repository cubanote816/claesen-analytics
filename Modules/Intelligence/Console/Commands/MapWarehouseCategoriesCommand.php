...
{
    protected $signature = 'intelligence:map-warehouse-categories {--limit=1000 : Limit items to process per run}';
    ...
    public function handle()
    {
        ...
        $stats = DB::table('intelligence_mirror_costs as c')
            ->join('intelligence_mirror_projects as p', 'c.project_id', '=', 'p.id')
