...
use Modules\FieldOps\Filament\Resources\Catalogs\AccessTypes\Pages\CreateAccessType;
use Modules\FieldOps\Filament\Resources\Catalogs\AccessTypes\Pages\EditAccessType;
use Modules\FieldOps\Filament\Resources\Catalogs\AccessTypes\Pages\ListAccessTypes;
use Modules\FieldOps\Models\AccessType;

class AccessTypeResource extends Resource
{
    protected static ?string $model = AccessType::class;
    ...
    {
        return __('fieldops::resource.catalogs.access_types');
    }
    ...
    {
        return [
            'index'  => ListAccessTypes::route('/'),
            'create' => CreateAccessType::route('/create'),
            'edit'   => EditAccessType::route('/{record}/edit'),
        ];
    }
}
