...
/**
 * Terrain belongsToMany ElectricalBoard (fo_electrical_board_terrain) — on a
 * terrain detail page, users can either create a new board for this terrain or
 * attach an existing shared board.
 */
