...
@once
    <style>
        ...
        .dark .fieldops-structure-location-picker {
        ...
        .fieldops-structure-location-picker__header {
            display: flex;
        ...
        .dark .fieldops-structure-location-picker__header {
            border-bottom-color: rgba(255, 255, 255, 0.08);
        }

        .fieldops-structure-location-picker__eyebrow {
            color: #009bd6;
            font-size: 0.68rem;
            font-weight: 800;
        ...
        .fieldops-structure-location-picker__title {
            margin-top: 0.35rem;
            color: #0f172a;
            font-size: 1.05rem;
            font-weight: 800;
        ...
        .dark .fieldops-structure-location-picker__title {
            color: #f8fafc;
        }

        .fieldops-structure-location-picker__description {
            margin-top: 0.3rem;
            color: #64748b;
            font-size: 0.9rem;
            line-height: 1.45;
        ...
        .dark .fieldops-structure-location-picker__description {
            color: #94a3b8;
        }

        .fieldops-structure-location-picker__coords {
            display: flex;
        ...
        .fieldops-structure-location-picker__coords-pill {
            display: inline-flex;
            align-items: center;
        ...
        .dark .fieldops-structure-location-picker__coords-pill {
            border-color: rgba(0, 174, 239, 0.24);
            background: rgba(0, 174, 239, 0.12);
            color: #7dd3fc;
        }

        .fieldops-structure-location-picker__hint {
            color: #64748b;
            font-size: 0.78rem;
            line-height: 1.4;
        }

        .dark .fieldops-structure-location-picker__hint {
            color: #94a3b8;
        }

        .fieldops-structure-location-picker__map {
            position: relative;
            z-index: 0;
            height: 480px;
            min-height: 480px;
        ...
        .fieldops-structure-location-picker__footer {
            display: flex;
            flex-wrap: wrap;
            gap: 0.75rem;
            justify-content: space-between;
        ...
        .dark .fieldops-structure-location-picker__footer {
            border-top-color: rgba(255, 255, 255, 0.08);
            color: #94a3b8;
        }

        .fieldops-structure-location-picker .leaflet-container {
            background: transparent;
        }

        .fieldops-structure-location-picker .leaflet-control-zoom,
        .fieldops-structure-location-picker .leaflet-control-attribution {
            border: 1px solid rgba(148, 163, 184, 0.18);
            box-shadow: 0 8px 22px rgba(15, 23, 42, 0.12);
        }

        .fieldops-structure-location-picker .leaflet-control-zoom a {
            background: #fff;
            color: #0f172a;
        }
        ...
        .fieldops-structure-location-picker__pin {
            width: 1.25rem;
            height: 1.25rem;
        ...
        .fieldops-structure-location-picker__pin::after {
            content: "";
            position: absolute;
            inset: 0;
            margin: auto;
...
<div
    ...
    x-data="fieldopsElectricalBoardLocationPicker({
        ...
        terrainLabel: @js($data['terrainLabel']),
    })"
    x-init="init()"
>
    @once
        ...
        window.fieldopsRegisterElectricalBoardLocationPicker = window.fieldopsRegisterElectricalBoardLocationPicker || function () {
            ...
            window.Alpine.data('fieldopsElectricalBoardLocationPicker', (config) => ({
                ...
                centerLngInput: null,
                coordsLabel: '',
                terrainLabel: config.terrainLabel,
                ...
                async init() {
                    ...
                    this.marker = L.marker([initial.lat, initial.lng], {
                        ...
                        icon: L.divIcon({
                            className: '',
                            html: '<div class="fieldops-structure-location-picker__pin"></div>',
                            iconSize: [24, 24],
                            iconAnchor: [12, 24],
                        }),
                    }).addTo(this.map);
    ...
    <div class="fieldops-structure-location-picker__header">
        <div>
            <div class="fieldops-structure-location-picker__eyebrow">Location</div>
            <div class="fieldops-structure-location-picker__title">Adjust the structure pin</div>
            <div class="fieldops-structure-location-picker__description">
                Click on the map or drag the pin to set the exact structure coordinates.
            </div>
        </div>

        <div class="fieldops-structure-location-picker__coords">
            <div class="fieldops-structure-location-picker__coords-pill" x-text="coordsLabel"></div>
            <div class="fieldops-structure-location-picker__hint">
                <template x-if="terrainLabel">
                    <span>Starting from <span x-text="terrainLabel"></span>.</span>
                </template>
                <template x-if="! terrainLabel">
    ...
    <div x-ref="map" class="fieldops-structure-location-picker__map"></div>

    <div class="fieldops-structure-location-picker__footer">
