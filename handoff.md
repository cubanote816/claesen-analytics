...
> Última actualización: 2026-08-03 — **CLA-304** permite al agente crear y mover automáticamente los tickets Linear necesarios para solicitudes autorizadas con cambios. Se conservan el plan y la aprobación antes de editar, las pruebas/checks, el GO técnico y el cierre controlado. **WAIVER — CLA-304:** cambio exclusivamente documental; riesgo residual = incoherencia entre reglas; cobertura alternativa = revisión cruzada de las reglas y `git diff --check`; aprobado por GO técnico del usuario el 2026-08-03. Pendiente: commit dedicado y cierre de Linear.
