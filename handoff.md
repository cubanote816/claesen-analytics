...
> Última actualización: 2026-07-04 (merge de `issue-dashboard` a `main`: CLA-215/216/217 dashboard Safety + FO-009/CLA-213 dominio de Mantenimiento, commit `afd5e43`)

---

## Estado actual

- **Sprint activo:** ninguno declarado (FO-009 recién cerrado; dashboard Safety CLA-215/216/217 recién mergeado desde `issue-dashboard`).
