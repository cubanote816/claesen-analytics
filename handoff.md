...
- **Rama actual:** `main`
- **Último ticket cerrado:** WEB-008 / CLA-108 — "Base multidioma del portfolio (nl/en/fr/de)" — commit `9a626cd`
- **Próximo ticket:** WEB-009 / CLA-109 — "IA para caption/alt de imágenes de galería"
