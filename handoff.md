...
> Última actualización: 2026-07-05 (merge `issue-dashboard` → `main`: CLA-219/221/222/223/224/225 + CLA-208 (port) — Billing Control, scroll de sidebar, Offer Simulator, sesión expirada — sobre el `main` ya actualizado con FO-009/CLA-213, FO-010/CLA-214 y CLA-215/216/217)
