...
> Última actualización: 2026-07-21 — **CLA-261 implementado, verificado y cerrado**: la vista de Luminaire Frame ahora abre con un resumen gerencial y mantiene la edición espacial en un modo técnico separado. Se corrigió la clave de traducción visible, la semántica de estados, el ancho desktop y la duplicación de coordenadas. Los controles del plano quedaron junto al área que modifican, fullscreen elimina el encabezado gerencial y el panel contextual de la vista Overview puede ocultarse para ceder todo su ancho al frame. El contexto previo de FieldOps (CLA-230 a CLA-255) se mantiene sin cambios; CLA-248 sigue en backlog.
