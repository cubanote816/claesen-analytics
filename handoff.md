...
> Última actualización: 2026-07-27 — CLA-278: imágenes reales del catálogo Frame Types + fix de un bug real de navegación (`wire:navigate` + `@push('scripts')`/`alpine:init`) que dejaba el editor de imagen de Frame Types inerte al llegar por click desde el listado. Commit `a935834`. CLA-278 sigue In Progress — pendiente decidir si se cierra ya o se sigue sumando QA.
