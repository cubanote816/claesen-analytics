...
> Última actualización: 2026-08-03 — **CLA-320** corrige el contraste del selector nativo “Add luminaire” en dark mode: el control declara `color-scheme: dark` y sus opciones usan fondo `#171725` con texto claro. Playwright abrió el modal real y confirmó los estilos computados del selector y sus opciones; se eliminaron usuario, frame, tipos y script temporales de QA. La regresión renderizada y `git diff --check` están limpios. Pendiente: commit dedicado y cierre de Linear.
