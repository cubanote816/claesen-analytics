    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
        ...
        <div class="lg:col-span-8 bg-white/70 dark:bg-gray-900/40 backdrop-blur-2xl border border-white/20 dark:border-white/5 rounded-[2rem] p-6 shadow-xl h-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="relative group p-4 rounded-2xl transition-all hover:bg-white/50 dark:hover:bg-white/5 border border-transparent hover:border-white/20 dark:hover:border-white/5 shadow-none hover:shadow-lg hover:shadow-primary-500/5 cursor-pointer">
